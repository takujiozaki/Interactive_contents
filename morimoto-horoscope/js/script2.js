...
// $(function() {
//    $("."+`${getImageName(horoscope.sign)}`).on('click', function() {
//        $("#"+`${getImageName(horoscope.sign)}`).toggleClass('is-surface').toggleClass('is-reverse');
//    });
//  });
// 
 $(function() {
    $("button").on('click', function() {
      ...
      // JavaScript Documen// JavaScript Document